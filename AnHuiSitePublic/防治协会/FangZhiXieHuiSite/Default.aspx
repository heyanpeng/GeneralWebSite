...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
                    ...
                    <ItemTemplate>
                        <li>
                            <a href='content.aspx?id=<%#Eval("Id")%>' title="<%#Eval("Title")%>" target="_blank">
                                <%#AnHuiSite.Common.SubStr(Eval("Title").ToString(),60) %>
                            </a>
                        </li>
                    </ItemTemplate>
                </asp:Repeater>
    ...
    <div class="center">
        ...
        <div class="newsdynamic">
            <div class="newshead">
                协会动态
                <span class="more"><a href="List.aspx?Id=a7e585f521e948a09fcf23360fc85775" title="查看更多">More（更多）</a></span>
            </div>
            <div class="newslist">
                <ul>
    ...
    <div class="bottom">
        <div class="newscommunicate">
            <div class="newshead">
                经验交流
                <span class="more"><a href="List.aspx?Id=a9b6ac0838a043a28dcdc610226872bc" title="查看更多">More（更多）</a></span>
            </div>
            <div class="newslist">
                <ul>
        ...
        <div class="newsindustry">
            <div class="newshead">
                行业动态
                <span class="more"><a href="List.aspx?Id=db6e5b8e707e415e9864403fabf282d2" title="查看更多">More（更多）</a></span>
            </div>
            <div class="newslist">
                <ul>
