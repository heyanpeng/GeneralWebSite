                        ...
                        <div class="lbcontainer">
                            <div class="slide" style="display: block;">
                                ...
                                <div class="content-main-feature">
                                    <ul id="myTabCenter" class="nav nav-tabs">
                                        <li class="active">
                                            <a href="#zuixinyaowen" data-toggle="tab" style="height: 32px; line-height: 10px;">最新要闻
                                            </a>
                                        </li>
                                        <li><a href="#shixianxinwen" data-toggle="tab" style="height: 32px; line-height: 10px;">市县新闻</a></li>
                                    </ul>
                                    <div id="myTabContent" class="tab-content">
                                                ...
                                                <ItemTemplate>
                                                    <div class="feature green">
                                                        <a href='content.aspx?id=<%#Eval("Id")%>' class="current" title="<%#Eval("Title")%>" target="_blank">
                                                            <span><%#AnHuiSite.Common.SubStr(Eval("Title").ToString(),30) %></span>
                                        ...
                                        <div class="tab-pane fade" id="shixianxinwen">
                            ...
                            <div id="normalcon_right2">
                                <div>
                                    <table class="sudokuZWGK">
                                        <tr>
                                            <td>
                                                <a href="http://www.ssfzz.cn:8001/" target="_blank" title="视频会议">
                                        ...
                                        <tr>
                                            ...
                                            <td>
                                                <a href="file.aspx?Id=6322447e140a4df499f06b5f0bcfa62c" title="文件下载">
                                                    <img src="Style/images/sudoku/文件下载.png" /><br />
                                                    文件下载</a>
                                            </td>
                                        </tr>
                                    </table>
