...
<html>
	...
	<body>
		...
		<tr>
		<td>
			<span id="label" runat="server" class="Label">进&#160;度:</span>
		</td>
		<td id="barTd" >
			<div id="statusDiv" runat="server" class="StatusMessage">&#160;
				<Upload:DetailsSpan id="normalInProgress" runat="server" WhenStatus="NormalInProgress" style="font-weight: normal; white-space: nowrap;">
					...
					(<%# String.Format("{0:0%}", FractionComplete) %>) 速率: <%# FormatRate(BytesPerSec) %>
					- <%# FormatTimeSpan(TimeRemaining) %> 剩余时间
				</Upload:DetailsSpan>
