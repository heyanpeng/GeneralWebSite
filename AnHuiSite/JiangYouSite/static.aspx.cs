...
namespace AnHuiSite
{
    public partial class _static : System.Web.UI.Page
    {
        ...
        void BindContent(string id)
        {
            ...
            if (model == null)
                return;
            litStaticContent.Text = HttpUtility.HtmlDecode(model.Content).Replace("<img src=\"", "<img src=\"../ahadmin/").Replace("href=\"assets/ueditor/net/upload/file",
                "href=\"../ahadmin/assets/ueditor/net/upload/file").Replace("\\AHAdmin\\", "..\\AHAdmin\\");
