<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="images.aspx.cs" Inherits="AnHuiSite.images" %>
                ...
                <div class="col-md-9 col-xs-9 contentright">
                            ...
                            <asp:Repeater runat="server" ID="rptNewsList">
                                <ItemTemplate>
                                    <a href="content.aspx?Id=<%#Eval("Id") %>" title="<%#Eval("Title") %>" target="_blank">
                                        <li>
                                            <div>
                                                <img src="/AHAdmin/<%#Eval("PicAddress").ToString() %>" />
                                            </div>
                                            <div class="subtitle">
                                                <%#AnHuiSite.Common.SubStr(Eval("Title").ToString(),16) %>
                                            </div>
                                        </li>
                                    </a>
                                </ItemTemplate>
                    ...
                    <div class="newspage" style="float: right;">
                        ...
                        <webdiyer:AspNetPager ID="anp" runat="server"
                            PageSize="15" OnPageChanged="anp_PageChanged" CssClass="pagination" LayoutType="Ul" PagingButtonLayoutType="UnorderedList" PagingButtonSpacing="0" CurrentPageButtonClass="active"
