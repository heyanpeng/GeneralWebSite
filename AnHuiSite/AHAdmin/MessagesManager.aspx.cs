...
{
    public partial class MessagesManager : System.Web.UI.Page
    {
        public string mName;
        public string uId;
        ...
        private void BindMessages()
        {
            ...
            var data = messagesManager.GetList(100, " T_M_Id='" + mId + "'", "ReplyTime desc");
        ...
        protected void gridContent_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                var cbNew = e.Row.Cells[6].FindControl("colNew") as HtmlInputCheckBox;
                if (cbNew != null)
                {
                    cbNew.Checked = Convert.ToBoolean(news.IsNew);
                }

                var cbHot = e.Row.Cells[6].FindControl("colHot") as HtmlInputCheckBox;
                if (cbHot != null)
                {
